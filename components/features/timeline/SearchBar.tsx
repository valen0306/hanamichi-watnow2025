    ...
    <div className={`px-4 py-4 bg-white ${className}`}>
      <form onSubmit={handleSubmit} className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 bg-gray-100 rounded-full text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:bg-white transition-colors"
        />
      </form>
    </div>
  )
